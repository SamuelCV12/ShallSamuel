...
| `crear` | `<archivo> `| crea un arrchivo de texto. | `crear Pruba` |
| `eliminar` | `<archivo> `| Elimina un archivo de texto ya creado previamente. | `eliminar Pruba` |
| `renombrar` | `<archivoViejo> <archivoNuevo>` | Renombra un archivo ya existente. |  `renombrar Pruba Prueba2.0` |
